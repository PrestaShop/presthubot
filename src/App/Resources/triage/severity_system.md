...
You are proposing the repository's existing `Regression` label ("Type:
regression"), not inventing a category — so hold it to the standard a
maintainer would apply before adding that label.
